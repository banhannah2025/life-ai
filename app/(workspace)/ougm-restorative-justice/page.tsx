      ...
      {canViewContent ? (
        <section className="space-y-10">
          ...
          <nav className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <ol className="mt-4 space-y-2 text-sm text-slate-700">
                {tableOfContents.map((item) => (
                  <li key={item.anchor} className="flex items-start gap-2">
                    ...
                    <a href={`#${item.anchor}`} className="hover:text-emerald-700 hover:underline">
                      {item.label}
                    </a>
                  </li>
                ))}
            ...
            <section id="section-orientation" className="space-y-4">
            ...
            <section id="section-modules" className="space-y-6">
            ...
            <section id="section-assets" className="space-y-6">
              <div className="space-y-2">
            ...
            <Card id="section-handbook" className="border-slate-200 shadow-sm">
              <CardHeader>
                <CardTitle className="text-xl font-semibold text-slate-900">Trainer handbook (digital)</CardTitle>
                <p className="text-sm text-slate-500">
                  Equip trainers with ready-to-use guidance for facilitating cohorts, documenting progress, and caring for
                  themselves. Expand each chapter to view outcomes, key practices, and the digital tools that support them.
                </p>
              </CardHeader>
              <CardContent>
            ...
            <Card id="section-printables" className="border-slate-200 shadow-sm">
              <CardHeader>
            ...
            <section id="digital-forms" className="space-y-6">
              <div className="space-y-2">
            ...
            <Card id="section-integration" className="border-slate-200 shadow-sm">
              <CardHeader>
            ...
            <section id="section-faq" className="space-y-6 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
              <div>
            ...
            <Card id="section-support" className="border-slate-200 bg-gradient-to-r from-emerald-50 to-sky-50 shadow-sm">
              <CardHeader>
