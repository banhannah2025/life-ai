        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild>
              <Button className="w-full sm:w-auto">Create matter</Button>
            </DialogTrigger>
        ...
        {hasCases ? (
          ...
          <Card className="border border-slate-200/70 bg-white shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Create your first case to populate the pipeline.</CardDescription>
            </CardHeader>
            <CardContent className="text-sm text-slate-600">
              When you add cases, you&apos;ll see real-time progress across intake, discovery, briefing, and hearings here.
            </CardContent>
            <CardFooter>
              <Button onClick={() => setCreateDialogOpen(true)}>Create matter</Button>
            </CardFooter>
          </Card>
        )}
      </section>
